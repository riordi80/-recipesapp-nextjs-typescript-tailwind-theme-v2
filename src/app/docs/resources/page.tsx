...
const resources: Resource[] = [
  {
    ...
    description: 'Archivo Excel pre-formateado para importar todas tus recetas existentes a TotXo de forma masiva.',
    type: 'Template',
  ...
  },
  {
    ...
    description: 'Lista verificable con todos los pasos necesarios para configurar TotXo correctamente.',
    type: 'Checklist',
    category: 'Configuración',
    format: 'PDF',
    size: '2.1 MB',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              ...
              la gestión de tu restaurante, incluso antes de usar TotXo.
            </p>
            ...
            <div className="flex items-start space-x-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  ...
                  TotXo puede importar y sincronizar todos tus datos.
                </p>
              </div>
            </div>
          </div>
