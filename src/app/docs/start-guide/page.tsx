        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Todo lo que necesitas saber para empezar con TotXo. 
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-12">
            ...
            <div className="space-y-2 text-blue-800">
              <div className="flex items-center">
                ...
                <span>Tener una cuenta activa de TotXo</span>
              </div>
              <div className="flex items-center">
                <CheckCircle className="h-4 w-4 text-blue-600 mr-2 flex-shrink-0" />
          ...
          <div className="mb-16">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600">Migra tu información existente a TotXo</p>
              </div>
            </div>
          ...
          <div className="mb-16">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600">Crea y gestiona tu primer evento en TotXo</p>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-8">
            ...
            <p className="text-gray-600 mb-6">
              Has completado la configuración básica de TotXo. Ahora estás listo para 
