...
const tutorials: Tutorial[] = [
  {
    id: '1',
    title: 'Configuración inicial de TotXo',
  ...
  },
  {
    ...
    description: 'Conecta TotXo con tu sistema de punto de venta para sincronización automática de datos.',
    duration: '22 min',
    level: 'Avanzado',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
              Aprende a usar TotXo con nuestros tutoriales paso a paso. 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              Sigue este orden para dominar TotXo paso a paso
            </p>
          </div>
